...
export function HandleRustServersServerIdPlayersSteamIdEventsConnected(socketIo: Server, socketMessages: MaxQueue, natsClient: NatsAsyncApiClient ) {
    natsClient.jetStreamPushSubscribeToV0RustServersServerIdPlayersSteamIdEventsConnected((err, msg, server_id, player_id, jetstreamMsg) => {
      ...
      ordered: true,
      config: {
        opt_start_seq: lastSeqV0RustServersServerIdEventsPlayerSteamIdConnected,
