...
Checkout the videos under [assets](./assets/).
...
- [The single page (./app/page.tsx)](./app/page.tsx), that is the frontend you see on the website.

## Getting Started

Create your own `.env` file by using the [./.env-example](./.env-example) as starting point. Set the GamingAPI credentials to gain access to the GamingAPI network.
